...
//altshift_taps DEVICE_FAMILY="Cyclone V" NUMBER_OF_TAPS=1 RAM_BLOCK_TYPE="AUTO" TAP_DISTANCE=1280 WIDTH=12 aclr clken clock shiftin shiftout taps INTENDED_DEVICE_FAMILY="Cyclone V" lpm_hint="RAM_BLOCK_TYPE=AUTO"
...
//altsyncram ADDRESS_REG_B="CLOCK0" DEVICE_FAMILY="Cyclone V" NUMWORDS_A=1278 NUMWORDS_B=1278 OPERATION_MODE="DUAL_PORT" OUTDATA_ACLR_B="CLEAR0" OUTDATA_REG_B="CLOCK0" RAM_BLOCK_TYPE="AUTO" READ_DURING_WRITE_MODE_MIXED_PORTS="OLD_DATA" WIDTH_A=12 WIDTH_B=12 WIDTH_BYTEENA_A=1 WIDTHAD_A=11 WIDTHAD_B=11 aclr0 address_a address_b clock0 clocken0 data_a q_b wren_a
...
module  buffer_IP_1280_altsyncram
	( 
	aclr0,
	address_a,
	address_b,
...
`endif
	...
	defparam
		...
		ram_block5a_0.port_a_address_width = 11,
		ram_block5a_0.port_a_data_width = 1,
		ram_block5a_0.port_a_first_address = 0,
		ram_block5a_0.port_a_first_bit_number = 0,
		ram_block5a_0.port_a_last_address = 1277,
		ram_block5a_0.port_a_logical_ram_depth = 1278,
		...
		ram_block5a_0.port_b_address_width = 11,
		...
		ram_block5a_0.port_b_last_address = 1277,
		ram_block5a_0.port_b_logical_ram_depth = 1278,
	...
	defparam
		...
		ram_block5a_1.port_a_address_width = 11,
		ram_block5a_1.port_a_data_width = 1,
		ram_block5a_1.port_a_first_address = 0,
		ram_block5a_1.port_a_first_bit_number = 1,
		ram_block5a_1.port_a_last_address = 1277,
		ram_block5a_1.port_a_logical_ram_depth = 1278,
		...
		ram_block5a_1.port_b_address_width = 11,
		...
		ram_block5a_1.port_b_last_address = 1277,
		ram_block5a_1.port_b_logical_ram_depth = 1278,
	...
	defparam
		...
		ram_block5a_2.port_a_address_width = 11,
		ram_block5a_2.port_a_data_width = 1,
		ram_block5a_2.port_a_first_address = 0,
		ram_block5a_2.port_a_first_bit_number = 2,
		ram_block5a_2.port_a_last_address = 1277,
		ram_block5a_2.port_a_logical_ram_depth = 1278,
		...
		ram_block5a_2.port_b_address_width = 11,
		...
		ram_block5a_2.port_b_last_address = 1277,
		ram_block5a_2.port_b_logical_ram_depth = 1278,
	...
	defparam
		...
		ram_block5a_3.port_a_address_width = 11,
		ram_block5a_3.port_a_data_width = 1,
		ram_block5a_3.port_a_first_address = 0,
		ram_block5a_3.port_a_first_bit_number = 3,
		ram_block5a_3.port_a_last_address = 1277,
		ram_block5a_3.port_a_logical_ram_depth = 1278,
		...
		ram_block5a_3.port_b_address_width = 11,
		...
		ram_block5a_3.port_b_last_address = 1277,
		ram_block5a_3.port_b_logical_ram_depth = 1278,
	...
	defparam
		...
		ram_block5a_4.port_a_address_width = 11,
		ram_block5a_4.port_a_data_width = 1,
		ram_block5a_4.port_a_first_address = 0,
		ram_block5a_4.port_a_first_bit_number = 4,
		ram_block5a_4.port_a_last_address = 1277,
		ram_block5a_4.port_a_logical_ram_depth = 1278,
		...
		ram_block5a_4.port_b_address_width = 11,
		...
		ram_block5a_4.port_b_last_address = 1277,
		ram_block5a_4.port_b_logical_ram_depth = 1278,
	...
	defparam
		...
		ram_block5a_5.port_a_address_width = 11,
		ram_block5a_5.port_a_data_width = 1,
		ram_block5a_5.port_a_first_address = 0,
		ram_block5a_5.port_a_first_bit_number = 5,
		ram_block5a_5.port_a_last_address = 1277,
		ram_block5a_5.port_a_logical_ram_depth = 1278,
		...
		ram_block5a_5.port_b_address_width = 11,
		...
		ram_block5a_5.port_b_last_address = 1277,
		ram_block5a_5.port_b_logical_ram_depth = 1278,
	...
	defparam
		...
		ram_block5a_6.port_a_address_width = 11,
		ram_block5a_6.port_a_data_width = 1,
		ram_block5a_6.port_a_first_address = 0,
		ram_block5a_6.port_a_first_bit_number = 6,
		ram_block5a_6.port_a_last_address = 1277,
		ram_block5a_6.port_a_logical_ram_depth = 1278,
		...
		ram_block5a_6.port_b_address_width = 11,
		...
		ram_block5a_6.port_b_last_address = 1277,
		ram_block5a_6.port_b_logical_ram_depth = 1278,
	...
	defparam
		...
		ram_block5a_7.port_a_address_width = 11,
		ram_block5a_7.port_a_data_width = 1,
		ram_block5a_7.port_a_first_address = 0,
		ram_block5a_7.port_a_first_bit_number = 7,
		ram_block5a_7.port_a_last_address = 1277,
		ram_block5a_7.port_a_logical_ram_depth = 1278,
		...
		ram_block5a_7.port_b_address_width = 11,
		...
		ram_block5a_7.port_b_last_address = 1277,
		ram_block5a_7.port_b_logical_ram_depth = 1278,
	...
	defparam
		...
		ram_block5a_8.port_a_address_width = 11,
		ram_block5a_8.port_a_data_width = 1,
		ram_block5a_8.port_a_first_address = 0,
		ram_block5a_8.port_a_first_bit_number = 8,
		ram_block5a_8.port_a_last_address = 1277,
		ram_block5a_8.port_a_logical_ram_depth = 1278,
		...
		ram_block5a_8.port_b_address_width = 11,
		...
		ram_block5a_8.port_b_last_address = 1277,
		ram_block5a_8.port_b_logical_ram_depth = 1278,
	...
	defparam
		...
		ram_block5a_9.port_a_address_width = 11,
		ram_block5a_9.port_a_data_width = 1,
		ram_block5a_9.port_a_first_address = 0,
		ram_block5a_9.port_a_first_bit_number = 9,
		ram_block5a_9.port_a_last_address = 1277,
		ram_block5a_9.port_a_logical_ram_depth = 1278,
		...
		ram_block5a_9.port_b_address_width = 11,
		...
		ram_block5a_9.port_b_last_address = 1277,
		ram_block5a_9.port_b_logical_ram_depth = 1278,
	...
	defparam
		...
		ram_block5a_10.port_a_address_width = 11,
		ram_block5a_10.port_a_data_width = 1,
		ram_block5a_10.port_a_first_address = 0,
		ram_block5a_10.port_a_first_bit_number = 10,
		ram_block5a_10.port_a_last_address = 1277,
		ram_block5a_10.port_a_logical_ram_depth = 1278,
		...
		ram_block5a_10.port_b_address_width = 11,
		...
		ram_block5a_10.port_b_last_address = 1277,
		ram_block5a_10.port_b_logical_ram_depth = 1278,
	...
	defparam
		...
		ram_block5a_11.port_a_address_width = 11,
		ram_block5a_11.port_a_data_width = 1,
		ram_block5a_11.port_a_first_address = 0,
		ram_block5a_11.port_a_first_bit_number = 11,
		ram_block5a_11.port_a_last_address = 1277,
		ram_block5a_11.port_a_logical_ram_depth = 1278,
		...
		ram_block5a_11.port_b_address_width = 11,
		...
		ram_block5a_11.port_b_last_address = 1277,
		ram_block5a_11.port_b_logical_ram_depth = 1278,
...
endmodule //buffer_IP_1280_altsyncram


//lpm_counter DEVICE_FAMILY="Cyclone V" lpm_direction="UP" lpm_modulus=1278 lpm_port_updown="PORT_UNUSED" lpm_width=11 clk_en clock q
...
//lpm_compare DEVICE_FAMILY="Cyclone V" LPM_WIDTH=11 ONE_INPUT_IS_CONSTANT="YES" aeb dataa datab
...
endmodule //buffer_IP_1280_cmpr

//synthesis_resources = lut 11 reg 11 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  buffer_IP_1280_cntr
	( 
	clk_en,
	clock,
...
`endif
	...
	assign
		wire_counter_reg_bit_asdata = (({11{sset}} & s_val) | ({11{(~ sset)}} & (({11{sload}} & data) | (({11{(~ sload)}} & modulus_bus) & {11{(~ updown_dir)}})))),
	...
	assign
		...
		wire_counter_reg_bit_sload = {11{((sset | sload) | modulus_trigger)}};
	buffer_IP_1280_cmpr   cmpr6
	( 
	.aeb(wire_cmpr6_aeb),
	.dataa(safe_q),
	.datab(modulus_bus));
	...
	assign
		...
		cout_actual = (((~ wire_counter_comb_bita_10cout[0:0]) ^ updown_other_bits) | (time_to_clear & updown_dir)),
		data = {11{1'b0}},
		external_cin = 1'b1,
		lsb_cin = 1'b0,
		modulus_bus = 11'b10011111101,
...
endmodule //buffer_IP_1280_cntr


//lpm_counter DEVICE_FAMILY="Cyclone V" lpm_avalue=1278 lpm_direction="DOWN" lpm_port_updown="PORT_UNUSED" lpm_width=11 aset clk_en clock cnt_en cout
//VERSION_BEGIN 25.1 cbx_cycloneii 2025:10:22:10:31:27:SC cbx_lpm_add_sub 2025:10:22:10:31:27:SC cbx_lpm_compare 2025:10:22:10:31:27:SC cbx_lpm_counter 2025:10:22:10:31:27:SC cbx_lpm_decode 2025:10:22:10:31:27:SC cbx_mgl 2025:10:22:10:31:44:SC cbx_nadder 2025:10:22:10:31:27:SC cbx_stratix 2025:10:22:10:31:27:SC cbx_stratixii 2025:10:22:10:31:26:SC  VERSION_END
...
`timescale 1 ps / 1 ps
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"{-to counter_reg_bit[1]} POWER_UP_LEVEL=HIGH;{-to counter_reg_bit[2]} POWER_UP_LEVEL=HIGH;{-to counter_reg_bit[3]} POWER_UP_LEVEL=HIGH;{-to counter_reg_bit[4]} POWER_UP_LEVEL=HIGH;{-to counter_reg_bit[5]} POWER_UP_LEVEL=HIGH;{-to counter_reg_bit[6]} POWER_UP_LEVEL=HIGH;{-to counter_reg_bit[7]} POWER_UP_LEVEL=HIGH;{-to counter_reg_bit[10]} POWER_UP_LEVEL=HIGH"} *)
module  buffer_IP_1280_cntr1
	( 
	aset,
	clk_en,
	clock,
...
`endif
	...
	// synopsys translate_off
	initial
		counter_reg_bit[7:7] = {1{1'b1}};
	// synopsys translate_on
	always @ ( posedge clock or  posedge aset)
		if (aset == 1'b1) counter_reg_bit[7:7] <= {1{1'b1}};
		else if  (wire_counter_reg_bit_ena[7:7] == 1'b1) 
			if (sclr == 1'b1) counter_reg_bit[7:7] <= 1'b0;
			else if (wire_counter_reg_bit_sload[7:7] == 1'b1) counter_reg_bit[7:7] <= wire_counter_reg_bit_asdata[7:7];
			else  counter_reg_bit[7:7] <= wire_counter_reg_bit_d[7:7];
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aset)
		if (aset == 1'b1) counter_reg_bit[9:9] <= 1'b0;
		else if  (wire_counter_reg_bit_ena[9:9] == 1'b1) 
			if (sclr == 1'b1) counter_reg_bit[9:9] <= 1'b0;
			else if (wire_counter_reg_bit_sload[9:9] == 1'b1) counter_reg_bit[9:9] <= wire_counter_reg_bit_asdata[9:9];
			else  counter_reg_bit[9:9] <= wire_counter_reg_bit_d[9:9];
	// synopsys translate_off
	initial
		counter_reg_bit[10:10] = {1{1'b1}};
	// synopsys translate_on
	always @ ( posedge clock or  posedge aset)
		if (aset == 1'b1) counter_reg_bit[10:10] <= {1{1'b1}};
		else if  (wire_counter_reg_bit_ena[10:10] == 1'b1) 
			if (sclr == 1'b1) counter_reg_bit[10:10] <= 1'b0;
			else if (wire_counter_reg_bit_sload[10:10] == 1'b1) counter_reg_bit[10:10] <= wire_counter_reg_bit_asdata[10:10];
			else  counter_reg_bit[10:10] <= wire_counter_reg_bit_d[10:10];
	...
	assign
		...
		updown_lsb = updown_dir,
		updown_other_bits = ((~ external_cin) | updown_dir);
endmodule //buffer_IP_1280_cntr1

//synthesis_resources = lut 22 M10K 3 reg 23 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  buffer_IP_1280_shift_taps
	( 
	aclr,
	clken,
	clock,
...
`endif
	...
	reg	dffe4;
	wire  [10:0]   wire_cntr1_q;
	wire  wire_cntr3_cout;

	buffer_IP_1280_altsyncram   altsyncram2
	( 
	.aclr0(dffe4),
	...
	buffer_IP_1280_cntr   cntr1
	( 
	.clk_en(clken),
	.clock(clock),
	.q(wire_cntr1_q));
	buffer_IP_1280_cntr1   cntr3
	( 
	.aset(aclr),
	.clk_en(clken),
	.clock(clock),
...
endmodule //buffer_IP_1280_shift_taps
//VALID FILE
...
`endif
	...
	buffer_IP_1280_shift_taps	buffer_IP_1280_shift_taps_component (
				.aclr (aclr),
				.clken (clken),
				.clock (clock),
				.shiftin (shiftin),
