...
//VERSION_BEGIN 24.1 cbx_a_gray2bin 2025:03:05:20:06:36:SC cbx_a_graycounter 2025:03:05:20:06:36:SC cbx_cycloneii 2025:03:05:20:06:36:SC cbx_mgl 2025:03:05:20:07:01:SC cbx_stratix 2025:03:05:20:06:36:SC cbx_stratixii 2025:03:05:20:06:36:SC  VERSION_END
...
`endif
	...
	defparam
		...
		ram_block9a_0.port_a_logical_ram_width = 8,
	...
	defparam
		...
		ram_block9a_1.port_a_logical_ram_width = 8,
	...
	defparam
		...
		ram_block9a_2.port_a_logical_ram_width = 8,
	...
	defparam
		...
		ram_block9a_3.port_a_logical_ram_width = 8,
	...
	defparam
		...
		ram_block9a_4.port_a_logical_ram_width = 8,
	...
	defparam
		...
		ram_block9a_5.port_a_logical_ram_width = 8,
	...
	defparam
		...
		ram_block9a_6.port_a_logical_ram_width = 8,
	...
	defparam
		...
		ram_block9a_7.port_a_logical_ram_width = 8,
...
`timescale 1 ps / 1 ps
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"AUTO_SHIFT_REGISTER_RECOGNITION=OFF;REMOVE_DUPLICATE_REGISTERS=OFF;SYNCHRONIZER_IDENTIFICATION=OFF;SYNCHRONIZATION_REGISTER_CHAIN_LENGTH = 2;suppress_da_rule_internal=d101;suppress_da_rule_internal=d102;suppress_da_rule_internal=d103;-name CUT ON -from rdptr_g -to ws_dgrp|FIFO_IP_dffpipe1:dffpipe13|dffe14a;-name SDC_STATEMENT \"set_false_path -from *rdptr_g* -to *ws_dgrp|FIFO_IP_dffpipe1:dffpipe13|dffe14a* \";-name CUT ON -from delayed_wrptr_g -to rs_dgwp|FIFO_IP_dffpipe:dffpipe10|dffe11a;-name SDC_STATEMENT \"set_false_path -from *delayed_wrptr_g* -to *rs_dgwp|FIFO_IP_dffpipe:dffpipe10|dffe11a* \""} *)
...
`endif
	...
	.datab(rdptr_g));
	FIFO_IP_cmpr   rdfull_eq_comp
	( 
	.aeb(wire_rdfull_eq_comp_aeb),
	.dataa(wire_rs_dgwp_q),
	.datab(rdptr_gs));
	FIFO_IP_cmpr   wrempty_eq_comp
	( 
	...
	assign
		...
		rdptr_gs = {(~ rdptr_g[3]), (~ rdptr_g[2]), rdptr_g[1:0]},
